...
const NavigationItems = ({ state, navigation, descriptors }) => {
  ...
  const numUnread =
    (stats?.numUnreadChats ?? 0) + (stats?.numUnreadIntros ?? 0);
      ...
      {state.routes.map((route, index) => {
        ...
        const iconBackgroundColor = (() => {
          if (appThemeName === "dark") {
            ...
            return isFocused ? "#ffffff" : "#FF6190";
          }
        })();
        ...
        const backgroundColor = (() => {
          ...
          return appThemeName === "dark" ? "#000000" : "#FF6190";
        })();
...
const WebBar = ({ state, navigation, tabBarStyle, descriptors }) => {
  ...
  return (
    <ScrollView
      style={{
        height: "100%",
        backgroundColor: appThemeName === "dark" ? "black" : "#F4AFC1",
        borderRightWidth: 5,
        borderColor: "black",
      }}
