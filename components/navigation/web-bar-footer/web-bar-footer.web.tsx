...
const SocialBadges = () => {
  return (
    ...
    >
      <li>
        <a target="_blank" href="https://twitter.com/bunkappin">
          <img src={twitterIcon.uri} style={{ height: "20px" }} />
        </a>
      </li>
      <li>
        <a target="_blank" href="https://www.instagram.com/bunkapp.in">
          <img src={redditIcon.uri} style={{ height: "20px" }} />
        </a>
      </li>
      <li>
        <a target="_blank" href="https://github.com/Bunk-Labs">
